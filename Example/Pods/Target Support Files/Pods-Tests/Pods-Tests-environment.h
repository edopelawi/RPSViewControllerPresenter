...
#define COCOAPODS_POD_AVAILABLE_RPSViewControllerPresenter
#define COCOAPODS_VERSION_MAJOR_RPSViewControllerPresenter 0
#define COCOAPODS_VERSION_MINOR_RPSViewControllerPresenter 1
#define COCOAPODS_VERSION_PATCH_RPSViewControllerPresenter 0
